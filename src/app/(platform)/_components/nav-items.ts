/**
 * @file nav-items.ts
 * @route /src/app/(platform)/_components/nav-items.ts
 * @description Definición de navegación compartida entre Sidebar (desktop) y BottomNav (mobile).
...
export const PATHS = {
  ...
  more:          "M4.5 12a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Zm6 0a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Zm6 0a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z",
...
export type NavIcon = keyof typeof PATHS;
...
] as const satisfies readonly { href: string; label: string; icon: NavIcon }[];

/** Accesos directos de la barra inferior (mobile) — el resto vive en la hoja "Más". */
export const BOTTOM_NAV_HREFS = ["/dashboard", "/monitoring", "/sheds", "/statistics"] as const;
